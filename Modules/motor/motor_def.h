...
{
    OPEN_LOOP = 0x0,            // 0000
    CURRENT_LOOP = 0x1 << 0,    // 0001
    SPEED_LOOP = 0x1 << 1,      // 0010
    ANGLE_LOOP = 0x1 << 2,      // 0100

    // only for checking
    SPEED_AND_CURRENT_LOOP = SPEED_LOOP | CURRENT_LOOP,       // 0011
    ANGLE_AND_SPEED_LOOP = ANGLE_LOOP | SPEED_LOOP,         // 0110  
    ALL_THREE_LOOP = ANGLE_LOOP | SPEED_LOOP | CURRENT_LOOP,  // 0111
} Closeloop_Type_e;

typedef enum
{
    FEEDFORWARD_NONE = 0x0,         // 0000
    CURRENT_FEEDFORWARD = 0x1 << 0, // 0001
    SPEED_FEEDFORWARD = 0x1 << 1,   // 0010
