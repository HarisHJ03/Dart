...
typedef enum
{
    ...
    PID_Integral_Limit = 0x01 << 0,              // 0000 0001
    PID_Derivative_On_Measurement = 0x01 << 1,   // 0000 0010
    PID_Trapezoid_Intergral = 0x01 << 2,         // 0000 0100
    PID_Proportional_On_Measurement = 0x01 << 3, // 0000 1000
    PID_OutputFilter = 0x01 << 4,                // 0001 0000
    PID_ChangingIntegrationRate = 0x01 << 5,     // 0010 0000
    PID_DerivativeFilter = 0x01 << 6,            // 0100 0000
    PID_ErrorHandle = 0x01 << 7,                 // 1000 0000
} PID_Improvement_e;
